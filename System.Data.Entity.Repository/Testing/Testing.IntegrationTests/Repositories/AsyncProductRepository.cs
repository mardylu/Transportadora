...
{
    public class AsyncProductRepository : AsyncRepositoryBase<RepositoryContext>, IAsyncProductRepository
    {
        public AsyncProductRepository(string connectionString = "")
            : base(throwExceptions: true, useTransactions: true, connectionString: connectionString)
        {
        ...
        public async Task<bool> AddProduct(Product product)
        {
            ...
            result = await AddAsync<Product>(product);
